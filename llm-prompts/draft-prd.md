...
# **7. High-Quality Example PRD (Developer Tools Focus)**

Below is a complete example showing what a high-quality PRD looks like.

---

h1. PRD — Unified Internal Documentation Search

h1. 🚀 Product Opportunity Assessment

h2. What opportunity (problem, need, or desire) will this project address?

Internal engineers at Cloudflare spend 2-3 hours per week searching for documentation across 5+ fragmented systems (Confluence, GitHub wikis, Google Docs, Notion, internal wikis). This documentation fragmentation creates several problems:

* *Slow onboarding:* New engineers take 2+ weeks to understand where to find information, delaying productivity
* *Duplicate work:* Teams waste time re-solving problems because they can't find existing solutions
* *Outdated information:* Engineers follow stale documentation (40% of docs are >6 months old) leading to errors and incidents
* *Lost productivity:* 15 minutes per search × 8-12 searches per week × 650 engineers = ~$520K/year in lost productivity

This problem is evidenced by:
* New hire survey (n=47): 89% cite "finding documentation" as top onboarding challenge
* Engineering survey Q4 2024 (n=203): Average satisfaction with documentation discoverability: 4.2/10
* Incident analysis: 12% of P2+ incidents in 2024 attributed to engineers following outdated documentation

h2. For whom do we address that opportunity?

*Primary users:* All Cloudflare engineers (650+ across Product Engineering, Infrastructure, Security, Data Platform)

*Specific segments:*
* *New hires (50-75 per quarter):* Highest pain point during onboarding; need fast path to productivity
* *Backend engineers (400+):* Heavy documentation consumers for APIs, services, infrastructure
* *SREs and on-call engineers (80+):* Need rapid access to runbooks and troubleshooting docs during incidents

*Secondary users:*
* Engineering managers who maintain team documentation
* Developer Experience team who manage documentation infrastructure

h2. How will we measure success/make money from this product?

This is an internal productivity tool; success measured by efficiency gains and user satisfaction.

*Primary metric:*
* *Time to find relevant documentation* decreases from 15 minutes (current baseline) to <2 minutes, measured via user survey and instrumented search behavior
* Target: 80% of searches result in relevant document found within 2 minutes by end of Q2 2025

*Secondary metrics:*
* *Weekly active users:* 500+ engineers (75% of engineering) using search weekly within 3 months of GA
* *Search success rate:* ≥80% of searches result in clicking a result in top 3 (indicates good relevance)
* *Documentation freshness:* Teams update documentation 20% more frequently (measured by edit rates) as visibility increases
* *New hire productivity:* Time to first successful deployment decreases from 14 days to ≤7 days

*User satisfaction:*
* Documentation discoverability satisfaction increases from 4.2/10 to ≥8.0/10 in quarterly engineering survey

*ROI:*
* Saving 1 hour/week per engineer × 650 engineers × $150/hour (loaded cost) = ~$5M/year in productivity gains
* Estimated development cost: $200K (2 engineers × 10 weeks)
...
* *Backstage (Spotify):* Open-source developer portal with docs plugin
  *Strengths:* Established ecosystem, good plugin architecture
  *Weaknesses:* Requires significant customization and operational overhead; doesn't integrate well with our existing Confluence + GitHub setup
  *Cost:* High operational burden (2-3 engineers to maintain)

* *Algolia DocSearch:* Hosted documentation search
  *Strengths:* Fast, good relevance
  *Weaknesses:* Designed for public docs, not multi-source internal docs; expensive at our scale (~$50K/year)
  *Cost:* $50K/year + integration work

* *Confluence built-in search:*
  *Strengths:* Already available
  *Weaknesses:* Only searches Confluence; slow (5-10 second queries); poor relevance; doesn't include GitHub, Notion, or other sources
  *Current state:* 68% of engineers report Confluence search as "poor" or "very poor"

*Internal alternatives:*

* *Current state (do nothing):* Continue with fragmented documentation across 5+ systems
  *Cost:* Ongoing productivity loss of ~$5M/year
  *Risk:* Continued slow onboarding, duplicate work, incidents from stale docs

* *Document everything in one system:* Force all docs into Confluence
  *Challenges:* Major change management effort; GitHub wikis and READMEs are natural home for code docs; unlikely to succeed
  *Timeline:* 6-12 months minimum

*Why build:*

External solutions don't address our specific problem (multi-source internal documentation) and are expensive to operate. Consolidating all docs into one system is impractical. Building a unified search layer across existing sources provides fastest time-to-value with minimal disruption to existing workflows.

Estimated development cost ($200K) pays back in <2 weeks of productivity gains.
...
* Engineers can find relevant internal documentation in <2 minutes (down from 15+ minutes)
* Documentation search becomes the default first step for problem-solving (instead of asking in Slack)
* Teams gain visibility into documentation usage, driving documentation quality improvements
* New hire onboarding accelerates as critical information becomes discoverable

*Non-goals:*

* We are *NOT* building a new documentation authoring system (teams continue using Confluence, GitHub, etc.)
* We are *NOT* replacing GitHub as the source of truth for code documentation
* We are *NOT* building real-time collaboration features (out of scope)
* We are *NOT* indexing private personal documents or email (only team/org documentation)
...
* Make unified search the default search on internal developer homepage (go/docs)
* Add search box to Cloudflare internal Chrome extension (used by 400+ engineers)
* Replace existing Confluence search link with unified search
* Include in new hire onboarding checklist (required activity in first week)

*Onboarding:*

* 5-minute interactive tutorial on first use (skippable for experienced users)
* Weekly tips in Slack #dev-tips channel ("Did you know you can filter by source?")
* Office hours 2x per week for first month (Tuesday/Thursday 2pm PT) for questions
* Comprehensive help docs on go/docs-search

*Adoption targets & measurement:*

* Week 6 (end of beta): 15 active users, ≥5 searches per user per week, NPS ≥7.0
* Week 10 (end of pilot): 50 active users, ≥8 searches per user per week, NPS ≥7.5
* Week 14: 200 active users (30% of engineering)
* Week 20: 500+ active users (75% of engineering)

*Measurement approach:*
* Track weekly active users (WAU) via instrumentation
* Track searches per user, clicks, and success metrics
* Monthly NPS survey (in-app, 1-question)
* Quarterly deep-dive survey on documentation discoverability

*Change management:*

* Partner with engineering managers to demo in team meetings
* Create 2-minute comparison video (old workflow vs. new workflow) showing time savings
* Highlight time savings and success stories in weekly engineering newsletter
* Identify and empower early adopters as champions within their teams
...
*Risk 1: Low adoption due to workflow disruption*
* *Likelihood:* Medium | *Impact:* High
* Engineers may resist changing from familiar (though inefficient) search patterns
* *Mitigation:* Integrate into existing workflows (replace Confluence search, add to dev homepage); make new tool strictly better, not just different; run structured pilots with influential teams first; gather and act on feedback quickly

*Risk 2: Search quality doesn't meet user expectations*
* *Likelihood:* Medium | *Impact:* High
* If search relevance is poor, users will revert to old tools within weeks
* *Mitigation:* Extensive beta testing with real queries from logs; implement user feedback mechanism ("Was this helpful?"); set quality bar (≥80% of searches return relevant result in top 3); continuous relevance tuning based on click data

*Risk 3: Performance degradation at scale*
* *Likelihood:* Low | *Impact:* Medium
* Search latency may increase as index grows beyond 100K documents
* *Mitigation:* Load testing with 5x projected scale before launch; implement multi-layer caching; performance monitoring with alerts at P95 >1.5s; establish performance SLA

*Risk 4: Stale data in search index*
* *Likelihood:* Medium | *Impact:* Medium
* If indexing pipeline fails or lags, search results become outdated
* *Mitigation:* Real-time indexing with 5-minute freshness SLA; monitoring and alerting on indexing lag; graceful degradation if source system is unavailable

h2. Cross-team dependencies

*Infrastructure team:*
* *Need:* Elasticsearch cluster provisioned and configured (3 nodes, 500GB storage)
* *Timeline:* Required by Week 2 of development
* *Status:* Initial conversation held with Infrastructure PM; formal request submitted; confirmed availability

*Security team:*
* *Need:* Security review for search indexing of private repositories and access control model
* *Timeline:* Required before beta launch (Week 4)
* *Status:* Security review meeting scheduled for Week 2; preliminary feedback: ensure search respects existing Confluence/GitHub permissions

*Developer Experience team:*
* *Need:* Integration with internal developer homepage (go/docs) and Chrome extension
* *Timeline:* Required for GA launch (Week 10)
* *Status:* Alignment meeting held; DevEx team committed to integration support; timeline confirmed

*Documentation team:*
* *Need:* Partnership on content quality standards, freshness monitoring, and documentation improvement initiatives
* *Timeline:* Ongoing collaboration throughout project and post-launch
* *Status:* Kickoff meeting held; Documentation team enthusiastic about visibility into usage data

h2. Customer Support impact

*New documentation needed:*

* User guide: "How to search across internal documentation" (~1 page on go/docs-search)
* FAQ covering common search scenarios and tips ("How do I filter by source?" "How do I find recent docs?" etc.)
* Video walkthrough (5 minutes) showing search in action
* Troubleshooting guide for common issues

*Existing documentation updates:*

* Update "Finding Documentation" section of New Hire Onboarding Guide
* Add to Developer Tools Overview page
* Update Confluence search help docs to point to new tool

*Training materials:*

* 30-minute demo presentation for Engineering All-Hands
* Self-service interactive tutorial (built into product, appears on first use)
* Weekly tips series for Slack #dev-tips channel (8 weeks of content prepared)

*Support plan:*

* Create #docs-search Slack channel for questions and feedback
* Weekly office hours for first month (Tuesday/Thursday 2pm PT)
* Expected support volume: High in first 2 weeks of each rollout phase (~50 questions), stabilizing to <5 questions per week after first month

h2. Analytics impact

*New instrumentation required:*

* `search_query_submitted` event
  _Properties:_ query_text_hash (one-way hash for privacy), user_id, timestamp, result_count, filters_applied

* `search_result_clicked` event
  _Properties:_ query_id, result_rank, doc_id, doc_source (Confluence/GitHub/Wiki), user_id, timestamp

* `doc_viewed` event
  _Properties:_ doc_id, doc_source, referrer, user_id, timestamp, time_on_page

* `search_feedback` event (thumbs up/down)
  _Properties:_ query_id, feedback_type, user_id, timestamp
...
* Searches per user per week
* Search success rate (clicks within top 3 results)
* Time to first click (proxy for relevance)
* Repeat search rate (same query within 5 minutes = failed search)
* Documentation view rates (trending docs, orphaned docs)

*Dashboard requirements:*

* *Product health dashboard:* WAU, searches per user, search success rate (refreshed daily)
* *Search quality dashboard:* Query analysis, zero-result queries, low-click queries, feedback analysis (refreshed daily)
* *Documentation insights dashboard:* Most-viewed docs, trending docs, stale docs (>6 months), orphaned docs (zero views in 30 days)

*Privacy considerations:*

* Query text will be one-way hashed (not stored in plaintext) to protect potentially sensitive search terms
* User_id tracked for analytics but aggregated in dashboards
* 90-day retention for event-level data; aggregated metrics retained indefinitely
* Dashboards available only to Product, Engineering Leadership, and Analytics teams

*Timeline:*

* Instrumentation specification complete: Week 1
* Instrumentation implemented and tested: Week 3
* Dashboards ready for beta launch: Week 4

h2. QA impact

*Quality built-in approach:*

Quality will be built in from the start through automated testing, structured beta testing, and continuous monitoring.

*Automated testing:*

* *Unit tests:* Search indexing logic, query parsing, result ranking (target: 90% code coverage)
* *Integration tests:* Search API (20+ test scenarios covering common queries, edge cases, error handling)
* *End-to-end tests:* Search UI flows (submit query, click result, apply filters, provide feedback)
* *Performance tests:* P95 latency <2s with 100 concurrent users, sustained load test (500 queries/minute for 1 hour)

*Manual testing:*

* *Beta user testing:* Structured feedback sessions with 15 engineers during beta (Weeks 4-6)
* *Accessibility testing:* WCAG 2.1 AA compliance (keyboard navigation, screen reader support)
* *Cross-browser testing:* Chrome (primary), Firefox, Safari
* *Mobile testing:* Responsive design for mobile browsers (secondary priority)

*Test data requirements:*

* Create test documentation corpus (100 docs covering different sources, types, and ages)
* Anonymized sample of real search queries from Confluence logs (500 queries for relevance testing)
* Synthetic queries covering edge cases (special characters, very long queries, etc.)

*Quality gates for launch:*

* All automated tests passing (unit, integration, E2E)
* P95 latency <2s in load tests with 100 concurrent users
* Zero critical or high security vulnerabilities
* Beta user satisfaction ≥7.0/10 NPS
* Search success rate ≥75% in beta testing
...
Build a unified search interface that indexes documentation from Confluence, GitHub (wikis and READMEs), and internal wikis into a centralized Elasticsearch cluster. Provide a clean, fast web UI with a single search box that returns ranked results across all sources.

*Key architectural decisions:*

* *Search engine:* Elasticsearch 8.x (proven at scale, good relevance tuning, strong full-text search)
* *Indexing:* Custom indexing pipelines for each source:
  ** Confluence: REST API polling every 5 minutes for updates
  ** GitHub: Webhook-based indexing for real-time updates to wikis and READMEs
  ** Internal wikis: API-based polling every 10 minutes
* *Frontend:* Lightweight React SPA served from internal developer portal (go/docs)
* *Backend:* Node.js API layer for search queries, access control, and analytics
* *Access control:* Search results respect source system permissions (Confluence space permissions, GitHub repo permissions)

*User experience:*

* *Single search interface:* Clean search box (similar to Google) on go/docs and embedded in internal Chrome extension
* *Instant results:* Results appear as you type (debounced, 300ms delay)
* *Clear source indicators:* Each result shows source (Confluence/GitHub/Wiki icon), last updated date, and freshness indicator
* *Filtering:* Filter by source, by team/space, by date range
* *Result actions:* Click result → opens document in original source system; "Was this helpful?" feedback
* *Keyboard shortcuts:* '/' to focus search, arrow keys to navigate results, Enter to open

[Mockup would be included here showing clean search interface with sample results]
...
* Infrastructure: Kubernetes, deployed to internal cluster
...
* *Goal:* Prove search value with single source; validate relevance and performance
* *Scope:*
  ** Index all Confluence spaces (~10K documents)
  ** Basic web UI with search box and results list
  ** Source indicators and last-updated timestamps
  ** Respect Confluence space permissions
  ** Basic instrumentation (search events, clicks)
  ** P95 latency <2s
* *Success criteria:*
  ** 15+ beta users (DevTools team) searching weekly
  ** Search success rate ≥70% (clicks in top 3)
  ** NPS ≥7.0 from beta users
  ** Zero security issues identified in review

*Release 2: GitHub Integration (Weeks 5-7)*

* *Goal:* Expand coverage to code documentation; prove multi-source search value
* *Scope:*
  ** Add GitHub wiki and README indexing (~5K documents)
  ** Source filtering in UI (Confluence/GitHub toggle)
  ** Unified result ranking across sources
  ** Real-time GitHub indexing via webhooks
* *Success criteria:*
  ** 50+ active users (3 pilot teams)
  ** Search success rate ≥75%
  ** GitHub results appear in ≥30% of searches
  ** Users report finding GitHub docs "much easier" in pilot survey

*Release 3: Enhanced Discoverability & GA Launch (Weeks 8-10)*

* *Goal:* Improve search quality, add freshness indicators, launch to all engineers
* *Scope:*
  ** Content freshness indicators (flag docs >6 months old)
  ** Internal wiki indexing (~2K documents)
  ** Search quality dashboard for continuous improvement
  ** Documentation insights dashboard (trending docs, stale docs)
  ** Help documentation and tutorial
  ** Integration with dev homepage and Chrome extension
* *Success criteria:*
  ** 200+ active users within 2 weeks of GA
  ** Search success rate ≥80%
  ** Documentation discoverability satisfaction ≥7.5/10 in engineering survey
  ** 500+ active users (75% of engineering) within 10 weeks of GA

h2. Estimated time frame

*Overall timeline: 10 weeks from kickoff to GA launch*

*Detailed milestones:*

* *Week 1:* Infrastructure setup (Elasticsearch cluster), indexing pipeline architecture
* *Week 2:* Confluence indexing pipeline implementation, security review
* *Week 3:* Basic web UI, search API, instrumentation
* *Week 4:* Beta launch with DevTools team; feedback gathering
* *Week 5-6:* GitHub integration, multi-source ranking, pilot expansion
* *Week 7:* Pilot feedback sessions, relevance tuning, bug fixes
* *Week 8-9:* Freshness indicators, internal wiki indexing, dashboards, help docs
* *Week 10:* GA launch preparation, integrations (dev homepage, Chrome extension), announcement

*Team allocation:*

* 2 full-stack engineers (full-time for 10 weeks)
* 1 product manager (50% time)
* Design support (2 weeks, design system already available)
* Security review (1 week in Week 2)

*Assumptions:*

* Infrastructure dependencies resolved within SLA (Elasticsearch cluster provisioned by Week 2)
* Security review identifies no major blockers (preliminary approval already received)
* No major competing priorities for engineering team
* Beta and pilot feedback doesn't require major scope changes

*Risks to timeline:*

* Search relevance tuning may take longer than expected (+1-2 weeks potential)
* Security review could identify issues requiring remediation (+1 week potential)
* Integration with dev homepage could be delayed if DevEx team has competing priorities (+1 week potential)

*Contingency:*

If timeline pressure emerges, we can descope internal wiki indexing to post-GA (covers only ~10% of searches based on analysis). This would maintain core value (Confluence + GitHub = 90% of documentation) while reducing scope.
